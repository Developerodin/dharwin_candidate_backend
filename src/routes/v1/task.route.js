...
router
  .route('/kanban-board')
  .get(auth(), validate(taskValidation.getKanbanBoard), taskController.getKanbanBoard);

router
  .route('/statistics')
  .get(auth(), validate(taskValidation.getStatistics), taskController.getStatistics);
...
router
  .route('/:taskId/status')
  .patch(auth(), validate(taskValidation.updateStatus), taskController.updateStatus);
